  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full lg:w-[35%] flex flex-col gap-6 text-left items-start z-30 pt-16 lg:pt-0">
        ...
        {/* Right canvas column */}
        <div className="w-full lg:w-[65%] h-[55%] lg:h-full flex items-center justify-center relative">
          <ParticleCloud />
        </div>
      </div>
    </section>
