    ...
    <section className="w-full bg-[#080C14] py-20 px-6 md:px-12 relative z-10 overflow-hidden text-center flex flex-col items-center justify-center">
      ...
      <div className="max-w-[900px] mx-auto relative z-10 flex flex-col items-center">
        ...
        <motion.h2
          ...
          className="font-serif text-4xl sm:text-6xl md:text-7xl font-bold tracking-tight text-[#FFFFFF] leading-[1.1] mb-8 select-none"
        >
          Detect faster. <br />
          <CDGradientText>Respond sooner.</CDGradientText>
        </motion.h2>
        ...
        <motion.span
          ...
          className="font-mono text-[10px] sm:text-xs font-semibold text-[#64748B] tracking-[0.18em] uppercase"
        >
          NO COMMITMENT · SENIOR ANALYST RESPONSE · CONTINUOUS COVERAGE
        </motion.span>
      </div>
    </section>
  );
