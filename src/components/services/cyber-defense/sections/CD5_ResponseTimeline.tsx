...
const TIMELINE_STAGES = [
  {
    ...
    time: "CONTINUOUS",
    detail: "Ingest structured telemetry across AWS/Azure/GCP, EDR feeds, Okta/AD identity, network flows, and WAF endpoints into a unified telemetry environment.",
  },
  {
    step: "02",
  ...
  },
  {
    ...
    time: "PROACTIVE",
    detail: "Senior analysts test threat hypotheses against historical telemetry to uncover emerging threats, living-off-the-land techniques, and persistent backdoor attempts.",
  },
  {
    step: "04",
    phase: "ROOT CAUSE INVESTIGATION",
    time: "ANALYST-LED",
    detail: "Senior SOC lead verifies the alert, determines initial access vector, identifies compromised host credentials, and measures total impact scope.",
  },
  {
    step: "05",
    phase: "RAPID CONTAINMENT",
    time: "CONTAINMENT GUIDANCE",
    detail: "Analyst-guided containment: isolate compromised hosts, revoke compromised IAM tokens, and block malicious external C2 IPs.",
  },
  {
    step: "06",
    phase: "CONTINUOUS TUNING",
    time: "SAME-DAY SUPPORT",
    detail: "Incident learnings are fed back into custom detection rules to continuously reduce recurring noise through rule tuning and harden cloud defenses against repeat vectors.",
  },
];
