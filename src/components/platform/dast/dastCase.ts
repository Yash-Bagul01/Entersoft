...
export const DAST_CASE: ExoApeCase = {
  ...
  images: {
    ...
    collage: [
      {
        src: u("photo-1787165574896-adae5bec834b", 3200),
        alt: "Glazed tower lit from within at dusk",
        tag: "01 / PROOF-BASED DAST ENGINE",
        headline: "Zero-False-Positive Dynamic Auditing",
        metric: "100% Verified Exploits",
        desc: "Executes live non-destructive attacks against running web apps and microservice APIs, proving exploitability with reproducible HTTP logs.",
      },
      {
        src: u("photo-1719400471588-575b23e27bd7"),
        alt: "Analyst reviewing telemetry across three monitors",
        tag: "02 / STATEFUL AI CRAWLER",
        headline: "DOM State Machine Mapping",
        metric: "Full SPA Coverage",
        desc: "Walks single-page applications, dynamic routes, and complex multi-step auth forms including SSO and MFA.",
      },
      {
        src: u("photo-1594915440248-1e419eba6611"),
        alt: "Fibre optic cabling patched into a network switch",
        tag: "03 / IAST RUNTIME CORRELATION",
        headline: "Inside-Out Execution Tracking",
        metric: "Exact Code Line Locators",
        desc: "Correlates external black-box payloads with internal IAST agents to pinpoint exact source file, class, and method.",
      },
      {
        src: u("photo-1706101299176-292d8c5e470e"),
        alt: "Translucent blue glass curves catching light",
        tag: "04 / API SECURITY AUDITING",
        headline: "REST, GraphQL & gRPC Fuzzing",
        metric: "Deep Payload Probes",
        desc: "Validates schema boundaries, injection flaws, BOLA, and broken object level authorization across API endpoints.",
      },
      {
        src: u("photo-1680992046626-418f7e910589"),
        alt: "Server rack illuminated in a dark equipment room",
        tag: "05 / SAFE PAYLOAD CONTAINMENT",
        headline: "Non-Destructive Attack Trees",
        metric: "0% Production Impact",
        desc: "Enforces strict execution boundaries, rate limits, and automated transaction rollbacks during live testing.",
      },
      {
        src: u("photo-1762271458610-5f402f8dedf3"),
        alt: "Modern office interior lit at night",
        tag: "06 / DEVSECOPS AUTOMATION",
        headline: "Automated Ticket & CI/CD Routing",
        metric: "Instant Pull Request Audits",
        desc: "Outputs actionable cURL scripts and frameworks patches directly into Jira, GitHub, and Slack.",
      },
      {
        src: u("photo-1770473859769-d5a601e54a63"),
        alt: "Illuminated towers at night",
        tag: "07 / CONTINUOUS TELEMETRY",
        headline: "Real-Time Attack Surface Monitoring",
        metric: "Continuous Coverage",
        desc: "Monitors application releases 24/7, catching new vulnerabilities on staging deploys before production.",
      },
    ],
  },
  objective: {
