        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-12">
          <div className="flex flex-col items-start gap-6 max-w-[900px]">
            ...
            >
              ...
              <span className="text-white/80">ONE OPERATING PICTURE</span>
            </motion.div>
            ...
            >
              Unified Command View — Role-Based Operating Picture
            </motion.h1>
            ...
            >
              Give CISOs, SOC operators, and engineering leaders role-based views of exposure, threat incidents, controls, remediation, and business impact.
            </motion.p>
            ...
            >
              <Button variant="primary" size="lg" asLink href="/#contact" className="gap-2 bg-[#08428C] hover:bg-[#0D518C] text-white border-none shadow-lg">
                Request Command View Demo <ArrowRight className="w-4 h-4" />
              </Button>
            </motion.div>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-16">
          <div className="flex flex-col gap-3 max-w-[750px]">
            ...
            <h2 className="text-[clamp(1.8rem,3.5vw,2.8rem)] font-display font-bold uppercase tracking-tight text-white">
              Powering Executive Visibility Practices
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: "Provides engineering leaders with full visibility into application security SLAs and pipeline health."
              },
              {
                name: "Cyber Defense Operations",
                href: "/services/siem",
                desc: "Gives CISOs an active operational picture of live threat incidents and SOC resolution velocity."
              }
            ].map((item) => (
