        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-12">
          <div className="flex flex-col items-start gap-6 max-w-[900px]">
            ...
            >
              ...
              <span className="text-white/80">DETECT TO RESPOND</span>
            </motion.div>
            ...
            >
              Threat Operations — Active Containment & Incident Response
            </motion.h1>
            ...
            >
              Connect live threat telemetry with exposed assets, identity roles, and applications to accelerate investigation, containment, and incident response.
            </motion.p>
            ...
            >
              <Button variant="primary" size="lg" asLink href="/#contact" className="gap-2 bg-[#08428C] hover:bg-[#0D518C] text-white border-none shadow-lg">
                View SOC Telemetry <ArrowRight className="w-4 h-4" />
              </Button>
            </motion.div>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-16">
          <div className="flex flex-col gap-3 max-w-[750px]">
            ...
            <h2 className="text-[clamp(1.8rem,3.5vw,2.8rem)] font-display font-bold uppercase tracking-tight text-white">
              Powering Threat Operations Practices
            </h2>
          </div>
            ...
            {[
              {
                ...
                href: "/services/siem",
                desc: "Powers 24/7 SOC telemetry monitoring, MDR detection capabilities, and rapid incident handling workflows."
              },
              {
