        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-12">
          <div className="flex flex-col items-start gap-6 max-w-[900px]">
            ...
            >
              ...
              <span className="text-white/80">DECISION TO ACTION</span>
            </motion.div>
            ...
            >
              Closed-Loop Remediation — Verified Fix Execution
            </motion.h1>
            ...
            >
              Push actions directly into developer workflows, verify code fixes automatically upon pull request merge, and reconcile verified outcomes back to the enterprise risk register.
            </motion.p>
            ...
            >
              <Button variant="primary" size="lg" asLink href="/#contact" className="gap-2 bg-[#08428C] hover:bg-[#0D518C] text-white border-none shadow-lg">
                Explore Workflow Integration <ArrowRight className="w-4 h-4" />
              </Button>
            </motion.div>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-16">
          <div className="flex flex-col gap-3 max-w-[750px]">
            ...
            <h2 className="text-[clamp(1.8rem,3.5vw,2.8rem)] font-display font-bold uppercase tracking-tight text-white">
              Powering Remediation Practices
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: "Ensures security vulnerabilities identified in CI/CD pipelines are tracked through to verified code fix."
              },
              {
                name: "Digital Trust",
                href: "/services/compliance-management",
                desc: "Provides auditors with cryptographic proof of timely vulnerability closure within mandated SLA windows."
              }
            ].map((item) => (
