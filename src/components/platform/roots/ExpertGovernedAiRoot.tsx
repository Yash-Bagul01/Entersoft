        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 flex flex-col gap-12">
          <div className="flex flex-col items-start gap-6 max-w-[900px]">
            ...
            >
              ...
              <span className="text-white/80">14 YEARS OF JUDGMENT</span>
            </motion.div>
            ...
            >
              Expert-Governed AI — AI Speed with Human Accountability
            </motion.h1>
            ...
            >
              AI accelerates signal correlation and fix generation. Senior human security experts govern high-impact decisions, actions, and closure.
            </motion.p>
            ...
            >
              <Button variant="primary" size="lg" asLink href="/#contact" className="gap-2 bg-[#08428C] hover:bg-[#0D518C] text-white border-none shadow-lg">
                Test AI Governance Model <ArrowRight className="w-4 h-4" />
              </Button>
            </motion.div>
          </div>
            ...
            {[
              {
                ...
                href: "/services/ai-ast",
                desc: "Applies rigorous guardrails and validation frameworks to LLM integrations and enterprise AI deployments."
              },
              {
                name: "Adversarial Validation",
                href: "/services/vapt",
                desc: "Combines human ethical hackers with AI-assisted exploit verification to maximize audit depth."
              }
            ].map((item) => (
