...
export const IAC_CASE: ExoApeCase = {
  ...
  images: {
    ...
    collage: [
      { src: u("photo-1558494949-ef010cbdcc31"), alt: "Data-centre corridor with running equipment" },
      { src: u("photo-1781007277509-b8cadd30cb45"), alt: "Curved building facade against a dramatic sky" },
      { src: u("photo-1680691257251-5fead813b73e"), alt: "Network switch with cabled ports" },
      { src: u("photo-1606814540563-5c02d62fd409"), alt: "Blue light in a darkened room" },
      { src: u("photo-1663932210347-164a05ed0ccd"), alt: "Industrial blue-and-black machine housing" },
      { src: u("photo-1771442062904-44dddcea7fcf"), alt: "Office building windows illuminated at night" },
    ],
  },
  objective: {
